...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    category: 'jersey-england',
    images: [
      '/jerseys/nike-away-2026-front.png',
      '/jerseys/nike-away-2026-back.png',
    ],
    thickness: [],
    lengths: ['S', 'M', 'L', 'XL', 'XXL', 'XXXL', 'XXXXL', 'Kids S', 'Kids M', 'Kids L'],
    isBestSeller: false,
