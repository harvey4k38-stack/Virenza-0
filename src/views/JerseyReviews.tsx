...
const REVIEWS: Record<string, { title: string; subtitle: string; reviews: Review[] }> = {
  'jg-england-2026-world-cup-home-shirt': {
    title: 'England Nike Home 2026 World Cup',
    subtitle: 'Customer Reviews',
    reviews: [
      { id: 1,  name: 'D.H.',    location: 'Manchester',  rating: 5, comment: 'Ordered this for my lad for his birthday. He absolutely loves it, wouldnt take it off the first day.' },
      { id: 2,  name: 'Sarah T.', location: 'Leeds',      rating: 5, comment: 'Got it for my son ahead of the World Cup. Quality is brilliant for the price, he was dead chuffed.' },
      { id: 3,  name: 'M.O.',    location: 'London',      rating: 5, comment: 'Brilliant.' },
      { id: 4,  name: 'Chris W.', location: 'Birmingham', rating: 5, comment: 'My boy has been going on about this shirt for months. Ordered it and arrived within the week. Big smiles.' },
      { id: 5,  name: 'J.P.',    location: 'Sheffield',   rating: 5, comment: 'Proper shirt. Fits great and looks exactly like the pictures.' },
      { id: 6,  name: 'Karen B.', location: 'Liverpool',  rating: 5, comment: 'Bought as a gift for my son who is football mad. He wore it straight away and hasnt stopped talking about it.' },
      { id: 7,  name: 'T.A.',    location: 'Newcastle',   rating: 5, comment: 'Top quality for the money. No complaints at all.' },
      { id: 8,  name: 'R.E.',    location: 'Bristol',     rating: 5, comment: 'Got this for my nephew, he said its the best shirt hes ever had lol. Safe to say he loves it.' },
      { id: 9,  name: 'A.F.',    location: 'London',      rating: 5, comment: 'Fabric feels premium. Better than I expected honestly.' },
      { id: 10, name: 'Pete M.', location: 'Manchester',  rating: 5, comment: 'Ordered one for me and one for my son. Both arrived fast and both over the moon with them.' },
      { id: 11, name: 'L.W.',    location: 'Leeds',       rating: 5, comment: 'Love it.' },
      { id: 12, name: 'G.K.',    location: 'Birmingham',  rating: 5, comment: 'My son spotted this online and kept dropping hints. Ordered it and honestly its great quality. He is over the moon.' },
      { id: 13, name: 'N.J.',    location: 'Sheffield',   rating: 5, comment: 'England home shirts dont get better than this. Clean design and the badge is sharp.' },
      { id: 14, name: 'H.R.',    location: 'London',      rating: 5, comment: 'Bought it to wear to the pub for the World Cup games. Looks the part.' },
      { id: 15, name: 'Donna C.', location: 'Liverpool',  rating: 5, comment: 'Treated my boy to this as an early Christmas present. He was absolutely speechless, brilliant quality.' },
      { id: 16, name: 'B.T.',    location: 'Newcastle',   rating: 5, comment: 'Washed it on 30 and came out perfect. No shrinkage, no fading. Really solid.' },
      { id: 17, name: 'K.S.',    location: 'Bristol',     rating: 5, comment: 'Simple, clean and exactly what an England home shirt should look like.' },
      { id: 18, name: 'F.N.',    location: 'London',      rating: 5, comment: 'Three lions badge is really well done. Looks proper on it.' },
      { id: 19, name: 'O.G.',    location: 'Manchester',  rating: 5, comment: '10/10.' },
      { id: 20, name: 'Mark D.', location: 'Leeds',       rating: 5, comment: 'Got for my son who is 9. He thinks hes playing at Wembley now every time he puts it on haha. Ace shirt.' },
      { id: 21, name: 'S.B.',    location: 'Birmingham',  rating: 5, comment: 'Delivery was quick and packaging was neat. Shirt is quality, really happy with it.' },
      { id: 22, name: 'C.M.',    location: 'Sheffield',   rating: 5, comment: 'Bought it on a whim and glad I did. One of those purchases you dont regret.' },
      { id: 23, name: 'J.V.',    location: 'London',      rating: 4, comment: 'Took a few more days than expected but the shirt itself is top notch. Would deffo order again.' },
      { id: 24, name: 'P.L.',    location: 'Liverpool',   rating: 4, comment: 'Slight delay on delivery but quality is great. My son loves it so cant complain.' },
    ],
  },
  'j-nike-away-2026': {
