...
const REVIEWS: Record<string, { title: string; subtitle: string; reviews: Review[] }> = {
  'jg-england-2026-world-cup-home-shirt': {
    ...
    reviews: [
      { id: 1,  name: 'D.H.',    location: 'Manchester',  rating: 5, comment: 'Proper shirt. Fits great and looks exactly like the pictures.' },
      ...
      { id: 4,  name: 'Chris W.', location: 'Birmingham', rating: 5, comment: 'Been waiting for a decent England home shirt for years. This is it. Really happy with the quality.' },
      { id: 5,  name: 'J.P.',    location: 'Sheffield',   rating: 5, comment: 'Clean design, badge looks sharp. Wore it down the pub and got a few compliments.' },
      { id: 6,  name: 'Karen B.', location: 'Liverpool',  rating: 5, comment: 'Ordered for my lad — he wore it straight away and hasnt stopped talking about it.' },
      { id: 7,  name: 'T.A.',    location: 'Newcastle',   rating: 5, comment: 'Top quality for the money. No complaints at all.' },
      { id: 8,  name: 'R.E.',    location: 'Bristol',     rating: 5, comment: 'Fabric feels premium. Better than I expected honestly.' },
      { id: 9,  name: 'A.F.',    location: 'London',      rating: 5, comment: 'Fits true to size. Ordered a medium as usual and it was spot on.' },
      { id: 10, name: 'Pete M.', location: 'Manchester',  rating: 5, comment: 'Arrived fast and well packaged. Exactly what you want.' },
      { id: 11, name: 'L.W.',    location: 'Leeds',       rating: 5, comment: 'Love it.' },
      { id: 12, name: 'G.K.',    location: 'Birmingham',  rating: 5, comment: 'England home shirts dont get better than this. Clean and the badge is well done.' },
      { id: 13, name: 'N.J.',    location: 'Sheffield',   rating: 5, comment: 'Washed it twice already. No shrinkage, no fading. Really solid.' },
      { id: 14, name: 'H.R.',    location: 'London',      rating: 5, comment: 'Bought it to wear for the World Cup games. Looks the part.' },
      { id: 15, name: 'B.T.',    location: 'Newcastle',   rating: 5, comment: 'Simple, clean, exactly what an England shirt should look like.' },
      { id: 16, name: 'K.S.',    location: 'Bristol',     rating: 5, comment: 'Three lions badge is really well done. Looks proper on it.' },
      { id: 17, name: 'F.N.',    location: 'London',      rating: 5, comment: '10/10.' },
      { id: 18, name: 'S.B.',    location: 'Birmingham',  rating: 5, comment: 'Delivery was quick, packaging was neat. Really happy with it.' },
      { id: 19, name: 'C.M.',    location: 'Sheffield',   rating: 5, comment: 'Bought it on a whim and glad I did. One of those purchases you dont regret.' },
      { id: 20, name: 'O.G.',    location: 'Manchester',  rating: 5, comment: 'Good weight to the fabric. Doesnt feel cheap at all.' },
      { id: 21, name: 'J.V.',    location: 'London',      rating: 4, comment: 'Took a few more days than expected but the shirt itself is top notch. Would deffo order again.' },
      { id: 22, name: 'P.L.',    location: 'Liverpool',   rating: 4, comment: 'Slight delay on delivery but quality is great. No complaints on the shirt itself.' },
    ],
  },
  'j-nike-away-2026': {
