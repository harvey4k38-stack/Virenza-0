      ...
      >
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-20">
          ...
          <div className="border border-brand-gray-light p-8">
            ...
            <p className="text-sm text-brand-gray-dark leading-relaxed">
              Standard shipping typically takes <strong>7-10 working days</strong> from dispatch. In some cases, delivery may take up to 25 working days depending on your location and demand. You will receive tracking information once your order has shipped.
            </p>
          </div>
          <div className="border border-brand-gray-light p-8">
        ...
        <div className="flex items-start gap-4 p-6 border border-brand-gray-light bg-brand-gray-light/10 mb-20">
          ...
          <div>
            ...
            <p className="text-sm text-brand-gray-dark leading-relaxed">
              Due to high demand, please allow <strong className="text-brand-black">7-10 working days</strong> for delivery. In some cases orders may take up to <strong className="text-brand-black">25 working days</strong>. We're working hard to get every order out as quickly as possible and appreciate your patience.
            </p>
          </div>
        </div>
