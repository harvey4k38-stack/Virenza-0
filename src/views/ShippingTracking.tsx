      ...
      >
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-20">
          ...
          <div className="border border-brand-gray-light p-8">
            ...
            <p className="text-sm text-brand-gray-dark leading-relaxed">
              Standard shipping typically takes <strong>10-15 working days</strong> from dispatch. In some cases, delivery may take up to 25 working days depending on your location and demand. You will receive tracking information once your order has shipped.
            </p>
          </div>
          <div className="border border-brand-gray-light p-8">
